      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-8 lg:py-0">
        <div className="max-w-md w-full space-y-6 md:space-y-8">
          <div className="text-center">
            ...
            <p className="text-sm md:text-base text-gray-600">Sign in to your sustainable fashion community</p>
          </div>
        ...
        <div className="h-full bg-gradient-to-br from-green-400 to-emerald-600 relative overflow-hidden">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center text-white p-8">
              <h2 className="text-2xl md:text-4xl font-bold mb-4">Join the Movement</h2>
              <p className="text-lg md:text-xl mb-6">Sustainable fashion starts with community</p>
              <div className="bg-white bg-opacity-20 backdrop-blur-sm rounded-lg p-6">
                <div className="grid grid-cols-2 gap-3 md:gap-4 text-center">
                  <div>
                    <div className="text-xl md:text-2xl font-bold">2.5K+</div>
                    <div className="text-xs md:text-sm">Items Swapped</div>
                  </div>
                  <div>
